...
gas. Remarkably, the measured particle yields are in very good agreement with thermal particle production at chemical freeze-out temperature of T = 156 MeV even for a weakly
...
Such fast and efficient technique allowed us to easily include the important effect of resonance
decays in a routine experimental analysis procedure of blast-wave fit {% cite Mazeliauskas:2019ifr %}. In addition, we integrated the fast resonance calculation in a hydrodynamic heavy-ion model and performed a detailed analysis of
